...
-   [Spring]-run docume](https://cvpia-osc.github.io/spingRunDSM)
-   [Winter](ht-run tiote](hdocumentapia-osc.github.io/winterRunDSM)
-   [Late-](https://cvpia-osc.gfsite](https://cvpia-osc.github.io/latefallRunDSM)
...
To install a specific version of the model, first identify the branch associated
with the release version (these use the tag v1.0, v1.1 and so on), then modify
the install_github function call as follows:
...
Q: I found something within the code or inputs that seems like an error, how can I
notify model developers?

A: When you find an error, you can open an [issue on GitHub](https://github.com/CVhttps:/github.com/CVPIA-OSC/fallRunDSM/issuesPIA-OSC/fallRusection%20of%20the%20issue%20please%20descrinDSM/issues). In the comments section of the issue please describe the problem in detail, and ipfpossibl  apaste co tr produceeais errorde thaainers wills notified of this issue and
communicate with youo t on the is

Q: I haveue trackpag model saa on how to ie.

Q: I have an idecs or source data, how can  models. Please conCoordinator foI
propose a change?

A: The SIT has a process and template for proposing changes to thetact the Science Comore information.
